...
import { Clock, MapPin, ShoppingBag, UtensilsCrossed, Leaf, Heart, Truck } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Seleccionamos los mejores vegetales y proteínas diariamente"
    },
    {
      icon: <Heart className="text-red-500" size={40} />,
      title: "Saludable y Delicioso",
      description: "Combinamos sabor y nutrición en cada ensalada que preparamos"
    },
    {
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Las ensaladas más frescas y deliciosas de la ciudad. 
              Ingredientes naturales, sabores auténticos, directo a tu mesa.
            </p>
            <button
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-orange-50 p-6 rounded-lg col-span-full md:col-span-2">
              <div className="text-center mb-4">
                <ShoppingBag className="text-orange-600 mx-auto mb-4" size={40} />
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div className="text-center">
                  <div className="bg-orange-100 w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-2 text-orange-600 font-bold">1</div>
                  <p>Elegí tu ensalada favorita del menú</p>
                </div>
                <div className="text-center">
                  <div className="bg-orange-100 w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-2 text-orange-600 font-bold">2</div>
                  <p>Personalizá agregando o quitando ingredientes</p>
                </div>
                <div className="text-center">
                  <div className="bg-orange-100 w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-2 text-orange-600 font-bold">3</div>
